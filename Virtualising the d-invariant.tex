...
\begin{figure}[hbt]
	...
	\end{subfigure}
	\hspace*{\fill}
	\caption{It can be easy or difficult to tell directly from a diagram what knot it represents. The diagram in (b) is from \cite{notes-on-knot-theory}.}
...
There is no fast algorithm to compute the virtual genus of a virtual knot, however the following theorem from \cite{parity-and-projection} does get us somewhere:
\begin{theorem}
